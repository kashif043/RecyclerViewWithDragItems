...
@ConfigPersistent
public final class MyDocsDetailPresenter extends BasePresenter<MyDocsDetailMvpView> {
    private final DataManager mDataManager;
    private CompositeDisposable mCompositeDisposable;

    @Inject
    MyDocsDetailPresenter(DataManager dataManager) {
        this.mDataManager = dataManager;
    }

    @Override
    public void attachView(MyDocsDetailMvpView myDocsDetailMvpView) {
        super.attachView(myDocsDetailMvpView);
    ...
    void getFiles(Context context, String path) {
